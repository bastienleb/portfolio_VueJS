export declare type StopAnimationFn = () => void;
export declare type SetValueCallback = (value: number) => void;
export declare type CurrentValue = number;
export declare type BezierParams = [number, number, number, number];
...
export declare type AnimateFn = (params: IParams) => StopAnimationFn;
...
export declare type AnimateByIntervalFn = (params: IParams) => StopAnimationFn;
